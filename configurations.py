...
class Configurations:
    def __init__(self):
        ...
        self.api_config = ApiConfig(api_name, is_debug, api_port)
        ...
        self.database_config = DatabaseConfig(dbms_host, dbms_user, dbms_password, dbms_name)
        ...
        self.feature_config = FeatureConfig(features_input_format, features_output_format)
        ...
        self.ann_config = AnnConfig(ann_model_file, ann_one_hot_model_file, ann_epochs, ann_batch_size, ann_test_size,
                                    ann_validation_split, ann_minimum_accuracy)
        ...
        self.other_config = OtherConfig(other_model_path, other_backup_path, other_file_name, root_directory,
                                        other_log_path)
